...
<img src="./img/Kubernetes-An-Enterprise-Guide.jpg" alt="Kubernetes – An Enterprise Guide" height="256px" align="right">
...
<ol>
  <li>⏭️ Docker and Container Essentials</li>
  <li>⏭️ Deploying Kubernetes Using KinD</li>
  <li>⏭️ Kubernetes Bootcamp</li>
  <li>⏭️ Services, Load Balancing, and Network Policies</li>
  <li>⏭️ External DNS and Global Load Balancing</li>
  <li>🛠️ Integrating Authentication into Your Cluster</li>
